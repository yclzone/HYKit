...
//static NSString * const kNetWorkingRequestTypeGetString  = @"GET";
//static NSString * const kNetWorkingRequestTypePostString = @"POST";
...
@implementation NSDictionary (HYParametersSign)
